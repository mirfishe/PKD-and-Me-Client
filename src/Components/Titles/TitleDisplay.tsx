        ...
        <Container>
            ...
            <Col xs="12">
                <h5>{props.titleData.titleName}
                    ...
                    {props.titleData.publicationDate !== null ? <p style={{marginLeft: "5px", fontSize: 18}}> ({props.titleData.publicationDate.toString().substring(0, 4)})</p> : null}

                    {props.categoryName !== null && props.categoryName !== "" ? <p style={{marginLeft: "10px", fontSize: 12}}> {props.categoryName}
